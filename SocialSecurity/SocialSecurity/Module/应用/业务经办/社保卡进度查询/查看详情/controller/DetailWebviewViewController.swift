...
extension DetailWebviewViewController:WKNavigationDelegate,WKUIDelegate{
    ...
    fileprivate func loadHost(string:String) {
        ...
        do {
            ...
            if contentStr != nil{
                var contentStrReplace = (contentStr! as NSString).replacingOccurrences(of: "##01", with: saveModel.xmStr1)
                ...
                contentStrReplace = (contentStr! as NSString).replacingOccurrences(of: "##09", with: saveModel.lxsjStr1)
                contentStrReplace = (contentStr! as NSString).replacingOccurrences(of: "##10", with: saveModel.lxdhStr1)
