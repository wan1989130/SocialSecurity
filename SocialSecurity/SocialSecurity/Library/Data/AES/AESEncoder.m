...
#pragma mark - AES加密
//将string转成带密码的data
+(NSString*)encryptAESString:(NSString*)string app_key:(NSString*)key
{
    //将nsstring转化为nsdata
    ...
    return [GTMBase64 stringByEncodingData:encryptedData];//[encryptedData base64Encoding];
}
